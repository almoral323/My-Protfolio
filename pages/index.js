      ...
      <main className='bg-white px-10 md:px-20 lg:px-40'>
        <section className="min-h-screen">
          ...
          <div className='text-center p-10'>
            ...
            <p className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto'>Description HERE</p>
          </div>
        ...
        <section>
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 flex flex-col items-center'>
              ...
              <h4 className='py-4 text-violet-700'>Coding Languages, Libraies, and Frameworks</h4>
              <div className='flex justify-between gap-9'>
                <div className='text-gray-800 py-1 text-left'>
                ...
                <div className='text-gray-800 py-1 text-right'>
                  <p>Bootstrap</p>
                  <p>Handlebars.js</p>
                  <p>MongoDb</p>
                  <p>MySQL</p>
